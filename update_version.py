...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright Ottworks, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/justify-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/justify-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/justify-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/justify-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/justify-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/justify-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/justify-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/justify.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/justify.iss",inplace=1):
